...
public class LocationFragment extends Fragment {
    ...
    //2) request fine location updates -> start thr GPS for me
    //3) given a latLng -> address and vise versa
    ...
    private void requestLocationUpdates() {
        ...
        //set number of current requests
        //request.setNumUpdates(45);

        //request.setSmallestDisplacement(1000);
        //request.setMaxWaitTime(60*1000*60);
